...
@section('nav_tabs')
	...
	<li class="active"><a href="{{ url('student/instructors') }}"><i class="fa fa-user-circle-o"></i> <span>Instructors</span></a></li>
...
@section('scripts')
	<script src="{{ URL::asset('js/student_instructor.js') }}"></script>
@endsection