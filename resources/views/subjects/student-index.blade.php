...
@section('nav_tabs')
	...
	<li class="active">
		...
		<ul aria-expanded="true">
			<li class="active"><a href="{{ url('student/subjects') }}">All Subjects</a></li>
			<li class=""><a href="{{ url('student/subjects/my') }}">My Subjects</a></li>
		</ul>
	</li>
...
@section('scripts')
	<script src="{{ URL::asset('js/student_subject.js') }}"></script>
@endsection