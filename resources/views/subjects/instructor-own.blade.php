...
@section('nav_tabs')
    ...
    <li class="active">
		...
		<ul aria-expanded="true">
			<li class=""><a href="{{ url('instructor/subjects') }}">All Subjects</a></li>
			<li class="active"><a href="{{ url('instructor/subjects/my') }}">My Subjects</a></li>
		</ul>
	</li>
...
@section('content')
	...
	<div class="well" id="well_subjects">
		<h4>Select your subjects suppose to teach!</h4>
		<form action="{{ url('/instructor/subjects/my/save') }}" method="POST">
				      	...
				      	@foreach ($subjects as $id => $subject)
				      		<div class="form-check">
				      			<label class="form-check-label" for="{{ $subject }}">
				      				...
				      				{{ $instructor->subjects()->allRelatedIds()->contains($id) ? "checked" : "" }}>
				      				{{ $subject }}	
				      			</label>
				      		</div>
				      	@endforeach	
...
@section('scripts')
	<script src="{{ URL::asset('js/instructor_my_subject.js') }}"></script>
@endsection