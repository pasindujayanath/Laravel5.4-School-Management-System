...
@section('nav_tabs')
	...
	<li class="active"><a href="{{ url('admin/classrooms') }}"><i class="fa fa-building"></i> <span>Classes</span></a></li>
@endsection
...
@section('content')
	<div class="row">
		...
		<div class="col-md-2">
			<br/>
			<button type="button" class="btn btn-primary btn-lg btn-link btn-add pull-right" id="btnAddClassroom">
...
@section('scripts')
	<script src="{{ URL::asset('js/admin_classroom.js') }}"></script>
@endsection